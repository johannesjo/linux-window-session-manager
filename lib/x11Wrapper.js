...
module.exports = (passedCFG) => {
  ...
  return {
    ...
    ME_restoreWindowPosition: wrapX11(restoreWindowPosition),
    ME_getWindowGeometry: wrapX11(getWindowGeometry),
    ME_closeWindow: wrapX11(closeWindow),
    ME_goToWorkspace: wrapX11(goToWorkspace),
